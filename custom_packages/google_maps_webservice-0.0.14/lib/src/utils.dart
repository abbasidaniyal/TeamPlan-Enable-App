...
const kGMapsUrl = 'https://cors-anywhere.herokuapp.com/https://maps.googleapis.com/maps/api';
...
abstract class GoogleWebService {
  ...
  @protected
  Future<Response> doGet(String url) => get(url, headers: {
  ...
  Future<Response> doPost(String url, String body) {
    return post(url, body: body, headers: {
      'Content-type': 'application/javascript',
      "Access-Control-Allow-Origin": "*",
    });
  }
